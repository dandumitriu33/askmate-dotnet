...
namespace Tests.Controller
{
    public class CommentsControllerShould
    {
        ...
        [Fact]
        public async Task RemoveQuestionComment_ReturnErrorViewOnNullQuestion()
        {
            // Arrange
            // mocking repository
            var mockRepo = new Mock<IAsyncRepository>();
        ...
        [Fact]
        public async Task RemoveQuestionComment_ReturnErrorViewOnException()
        {
            // Arrange
            // mocking repository
            var mockRepo = new Mock<IAsyncRepository>();
            ...
            Question tempQuestion = new Question { Id = 1, Title = "Test Title" };
            mockRepo.Setup(repo => repo.GetQuestionByIdWithoutDetailsAsync(It.IsAny<int>())).ReturnsAsync(tempQuestion).Verifiable();
            mockRepo.Setup(repo => repo.RemoveQuestionCommentById(It.IsAny<int>())).Throws(new Exception()).Verifiable();
        ...
        [Fact]
        public async Task RemoveAnswerComment_RedirectDetailsOnSuccess()
        {
            // Arrange
            // mocking repository
            var mockRepo = new Mock<IAsyncRepository>();
            ...
            Answer tempAnswer = new Answer { Id = 1, Body = "Test Body", UserId = "abcd" };
            mockRepo.Setup(repo => repo.GetAnswerByIdWithoutDetailsAsync(It.IsAny<int>())).ReturnsAsync(tempAnswer).Verifiable();
            mockRepo.Setup(repo => repo.RemoveAnswerCommentById(It.IsAny<int>())).Verifiable();
            ...
            // Act
            var result = await controller.RemoveAnswerComment(1, 1);
            ...
            mockRepo.Verify(x => x.GetQuestionByIdWithoutDetailsAsync(It.IsAny<int>()), Times.Once);
            mockRepo.Verify(x => x.GetAnswerByIdWithoutDetailsAsync(It.IsAny<int>()), Times.Once);
            mockRepo.Verify(x => x.RemoveAnswerCommentById(It.IsAny<int>()), Times.Once);
        }

        [Fact]
        public async Task RemoveAnswerComment_ReturnErrorViewOnNullAnswerComment()
        {
            // Arrange
            // mocking repository
            var mockRepo = new Mock<IAsyncRepository>();
            ...
            mockRepo.Verify(x => x.GetQuestionByIdWithoutDetailsAsync(It.IsAny<int>()), Times.Never);
            mockRepo.Verify(x => x.GetAnswerByIdWithoutDetailsAsync(It.IsAny<int>()), Times.Never);
            mockRepo.Verify(x => x.RemoveAnswerCommentById(It.IsAny<int>()), Times.Never);
        }

        [Fact]
        public async Task RemoveAnswerComment_ReturnErrorViewOnNullQuestion()
        {
            // Arrange
            // mocking repository
            var mockRepo = new Mock<IAsyncRepository>();
        ...
        [Fact]
        public async Task RemoveAnswerComment_ReturnErrorViewOnNullAnswer()
        {
            // Arrange
            // mocking repository
            var mockRepo = new Mock<IAsyncRepository>();
        ...
        [Fact]
        public async Task RemoveAnswerComment_ReturnErrorViewOnException()
        {
            // Arrange
            // mocking repository
            var mockRepo = new Mock<IAsyncRepository>();
            ...
            Answer tempAnswer = new Answer { Id = 1, Body = "Test Body", UserId = "abcd" };
            mockRepo.Setup(repo => repo.GetAnswerByIdWithoutDetailsAsync(It.IsAny<int>())).ReturnsAsync(tempAnswer).Verifiable();
            mockRepo.Setup(repo => repo.RemoveAnswerCommentById(It.IsAny<int>())).Throws(new Exception()).Verifiable();
